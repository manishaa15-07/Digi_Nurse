...
export default function PatientProfileScreen() {
    ...
    const loadUserData = async () => {
        try {
            ...
            setUserData(response.data as PatientData);
        } catch (error: any) {
    ...
    const handleChangePassword = async () => {
        ...
        try {
            const token = await storage.getItem('patientToken');
            await axios.post(`${API_BASE_URL}/api/patient/change-password`, {
                currentPassword,
                newPassword
            }, {
                headers: { Authorization: `Bearer ${token}` }
        ...
        <View style={styles.container}>
            ...
            <View style={styles.cardContainer}>
                <View style={styles.card}>
                    <Text style={styles.cardTitle}>Your DigiNurse Patient ID</Text>
            ...
            <View style={styles.cardContainer}>
                <View style={styles.card}>
                    ...
                    <View>
                        ...
                        <View style={styles.infoRow}>
                            <Text style={styles.infoText}>Date of Birth: {userData?.dob || 'Not provided'}</Text>
                        </View>

                        <View style={styles.infoRow}>
                            <Text style={styles.infoText}>Gender: {userData?.gender || 'Not specified'}</Text>
                        </View>

                        <View style={styles.infoRow}>
                            <Text style={styles.infoText}>
                                Caregiver Connections: <Text style={styles.linkText}>
                                    {userData?.linkedCaretakers?.length || 0} Caregivers
                                </Text>
                            </Text>
                        </View>
                    </View>
            ...
            <View style={styles.cardContainer}>
                <View style={styles.card}>
                    ...
                    <View style={styles.infoRow}>
                        <Text style={styles.infoText}>
                            Conditions: {userData?.conditions?.join(', ') || 'None specified'}
                        </Text>
                    </View>
